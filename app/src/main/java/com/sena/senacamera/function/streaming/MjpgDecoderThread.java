...
import com.sena.senacamera.SdkApi.StreamProvider;
import com.sena.senacamera.data.Mode.PreviewLaunchMode;
import com.sena.senacamera.utils.ScaleTool;
...
public class MjpgDecoderThread {
    private static final String TAG = MjpgDecoderThread.class.getSimpleName();
...
//                    AppLog.d(TAG, "IchTryAgainException");
...
//                AppLog.d(TAG, "getNextVideoFrame buffer size:"+buffer.getFrameSize() );

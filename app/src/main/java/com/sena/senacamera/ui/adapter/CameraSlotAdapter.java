...
public class CameraSlotAdapter extends BaseAdapter {
    ...
    public CameraSlotAdapter(Context context, List<CameraSlot> camSlotList, Handler handler) {
        this.context = context;
        this.camSlotList = camSlotList;
        this.listViewHeight = SystemInfo.getInstance().getMetrics(context).heightPixels;
        this.myHandler = handler;
    }
...
//                slotConnectStatusTV.setTextColor(context.getResources().getColor(R.color.yellow));
//                slotConnectStatusTV.setText(R.string.connected);
//                slotConnectStatusIV.setImageDrawable(context.getResources().getDrawable(R.drawable.status_connected));
//            } else {
//                slotConnectStatusTV.setTextColor(context.getResources().getColor(R.color.gray));
//                slotConnectStatusTV.setText(R.string.not_connected);
//                slotConnectStatusIV.setImageDrawable(context.getResources().getDrawable(R.drawable.status_disconnected));
//            }

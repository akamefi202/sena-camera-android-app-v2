...
public class MultiPbRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<RemoteMediaItemInfo> list;
    private OperationMode operationMode = OperationMode.MODE_BROWSE;
    private FileType fileType;
    private int width;

    public MultiPbRecyclerViewAdapter(Context context, List<RemoteMediaItemInfo> list, FileType fileType) {
        this.list = list;
...
//        notifyDataSetChanged();
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof RecyclerViewGridHolder) {
            ...
            RemoteMediaItemInfo itemInfo = list.get(position);
            if (itemInfo != null) {
...
//                    return getItemViewType(position) == TYPE_FOOTER ? gridManager.getSpanCount() : 1;
    ...
    public List<RemoteMediaItemInfo> getCheckedItemsList() {
        LinkedList<RemoteMediaItemInfo> checkedList = new LinkedList<RemoteMediaItemInfo>();

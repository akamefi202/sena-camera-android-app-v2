package com.sena.senacamera.data.Message;
...
public class AppMessage {
    public static final int ACTIVITY_MESSAGE = 0x0000;
    //For Activity 0x0001~0x0FFF
    //For LaunchActivity 0x0001~0x00FF
    public static final int LAUNCH_ACTIVITY = ACTIVITY_MESSAGE + 0x0000;
    public static final int MESSAGE_DELETE_CAMERA = LAUNCH_ACTIVITY + 0x01;
    ...
    public static final int LOCAL_ACTIVITY = ACTIVITY_MESSAGE + 0x0100;

    public static final int PREVIEW_ACTIVITY = ACTIVITY_MESSAGE + 0x0200;
    public static final int SETTING_OPTION_AUTO_DOWNLOAD = PREVIEW_ACTIVITY + 0X01;
    public static final int MESSAGE_LIVE_NETWORK_DISCONNECT = PREVIEW_ACTIVITY + 0X02;

    public static final int MPB_ACTIVITY = ACTIVITY_MESSAGE + 0x0300;
    ...
    public static final int DOWNLOAD_BEGIN = MPB_ACTIVITY + 0x7;
    public static final int DOWNLOAD_FINISHED = MPB_ACTIVITY + 0x8;
    public static final int DOWNLOAD_SUCCEED = MPB_ACTIVITY + 0x9;
    public static final int DOWNLOAD_FAILURE = MPB_ACTIVITY + 0xa;

    public static final int PHOTO_PBACTIVITY = ACTIVITY_MESSAGE + 0x0400;

    public static final int VIDEO_PBACTIVITY = ACTIVITY_MESSAGE + 0x0500;

    public static final int LOCAL_VIDEO_PBACTIVITY = ACTIVITY_MESSAGE + 0x0600;
    ...
    public static final int FUNCTION_MESSAGE = 0x1000;
	...
	public static final int FACEBOOK_LOGIN_SUCCEED = FUNCTION_MESSAGE + 0x05;
    public static final int OPEN_WIFI_HOTSPOT_FAILED = FUNCTION_MESSAGE + 0x06;
    public static final int GOOGLE_LOGIN_SUCCEED = 0x06;

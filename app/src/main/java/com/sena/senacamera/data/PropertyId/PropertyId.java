...
public class PropertyId {
    ...
    public static final int CAPTURE_DELAY = ICatchCamProperty.ICH_CAM_CAP_CAPTURE_DELAY;
    public static final int BURST_NUMBER = ICatchCamProperty.ICH_CAM_CAP_BURST_NUMBER;
    public static final int WHITE_BALANCE = ICatchCamProperty.ICH_CAM_CAP_WHITE_BALANCE;
    ...
    public static final int DATE_STAMP = ICatchCamProperty.ICH_CAM_CAP_DATE_STAMP;
    // akamefi202: Photo Resolution
    public static final int IMAGE_SIZE = ICatchCamProperty.ICH_CAM_CAP_IMAGE_SIZE;
    public static final int VIDEO_SIZE = ICatchCamProperty.ICH_CAM_CAP_VIDEO_SIZE;
    ...
    //新增属性 20170316
    // akamefi202: Screen Saver (General Settings)
    public static final int SCREEN_SAVER = 0xD720; //55072
    // akamefi202: Auto Power Off (General Settings)
    public static final int AUTO_POWER_OFF = 0xD721;//55073
    public static final int POWER_ON_AUTO_RECORD = 0xD722;//55074
    //曝光补偿
    public static final int EXPOSURE_COMPENSATION = 0xD723;//55075
    //图像防抖
    // akamefi202: EIS (Video Mode)
    public static final int IMAGE_STABILIZATION = 0xD724;//55076
    //录像时长
    // akamefi202: Loop Recording (Video Mode)
    public static final int VIDEO_FILE_LENGTH = 0xD725;//55077
    ...
    public static final int PHOTO_MODE = 0xE10C;
    public static final int PHOTO_VIDEO_IMAGE_QUALITY = 0x5004;
    public static final int PHOTO_ISO = 0x500F;
    public static final int PHOTO_VIDEO_EV = 0x5010;
    public static final int PHOTO_VIDEO_METERING = 0x500B;
    public static final int PHOTO_VIDEO_TIMELAPSE_DURATION = 0x501A;
    public static final int VIDEO_MODE = 0xE100;
    public static final int VIDEO_AUTO_LOW_LIGHT = 0xE10E;
    public static final int VIDEO_FOV = 0xE10D;
    public static final int GENERAL_AUDIO_INPUT = 0xE109;
    public static final int GENERAL_DISPLAY_BRIGHTNESS = 0xE10B;
    public static final int GENERAL_DEVICE_SOUND = 0xE10A;
    public static final int GENERAL_FRONT_DISPLAY = 0xE105;
    public static final int GENERAL_MAIN_STATUS_LED = 0xE106;
    public static final int GENERAL_BATTERY_STATUS_LED = 0xE107;
    public static final int GENERAL_LANGUAGE = 0xE108;
    public static final int GENERAL_COLOR_EFFECT = 0x5017;
    public static final int GENERAL_DATE_FORMAT = 0xE102;

...
public class PropertyId {
    ...
    public final static int PHOTO_MODE = 0xE10C;
    public final static int PHOTO_VIDEO_IMAGE_QUALITY = 0x5004;
    public final static int PHOTO_ISO = 0x500F;
    public final static int PHOTO_VIDEO_EV = 0x5010;
    public final static int PHOTO_VIDEO_METERING = 0x500B;
    public final static int PHOTO_VIDEO_TIMELAPSE_DURATION = 0x501A;
    public final static int VIDEO_MODE = 0xE100;
    public final static int VIDEO_AUTO_LOW_LIGHT = 0xE10E;
    public final static int VIDEO_FOV = 0xE10D;
    public final static int GENERAL_AUDIO_INPUT = 0xE109;
    public final static int GENERAL_DISPLAY_BRIGHTNESS = 0xE10B;
    public final static int GENERAL_DEVICE_SOUND = 0xE10A;
    public final static int GENERAL_FONT_DISPLAY = 0xE105;
    public final static int GENERAL_MAIN_STATUS_LED = 0xE106;
    public final static int GENERAL_BATTERY_STATUS_LED = 0xE107;
    public final static int GENERAL_LANGUAGE = 0xE108;
    public final static int GENERAL_COLOR_EFFECT = 0x5017;
    public final static int GENERAL_DATE_FORMAT = 0xE102;

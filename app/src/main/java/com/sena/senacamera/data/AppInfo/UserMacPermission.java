package com.sena.senacamera.data.AppInfo;
 ...
 */
public class UserMacPermission {
    private static UserMacPermission userMacPermission;
    private static HashMap<String, MacPermit> macPermitList;

    public UserMacPermission() {
        initUserMacPermission();
    }

    public static UserMacPermission getInstance() {
        if (userMacPermission == null) {
            userMacPermission = new UserMacPermission();
        }
        return userMacPermission;
    }

    public void initUserMacPermission() {

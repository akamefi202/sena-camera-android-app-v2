...
import com.sena.senacamera.Function.ThumbnailGetting.ThumbnailOperation;
...
//            stillCaptureStartBeep.start();
    ...
    public void createUIByMode(int appStateMode) {
        ...
        if (BaseProperties.getCaptureDelay().needDisplayByMode(appStateMode)) {
            ...
            previewView.setDelayCaptureTextTime(BaseProperties.getCaptureDelay().getCurrentUiStringInPreview());
        } else {
        ...
        if (BaseProperties.getImageSize().needDisplayByMode(appStateMode)) {
            ...
            previewView.setImageSizeInfo(BaseProperties.getImageSize().getCurrentUiStringInPreview());
        ...
        if (BaseProperties.getVideoSize().needDisplayByMode(appStateMode)) {
            ...
            previewView.setVideoSizeInfo(BaseProperties.getVideoSize().getCurrentUiStringInPreview());
            previewView.setRemainRecordingTimeText(ConvertTools.secondsToMinuteOrHours(cameraProperties.getRecordingRemainTime()));
        } else {
